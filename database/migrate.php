...
// على MySQL: VARCHAR/INT/DATETIME (TEXT + DEFAULT '' يفشل على إصدارات عديدة فيُتخطّى العمود خطأً)
$migrations = $isMysql ? [
    'parcel_code_suffix' => "ALTER TABLE campaigns ADD COLUMN parcel_code_suffix VARCHAR(50) NOT NULL DEFAULT ''",
    'opening_quantity' => "ALTER TABLE campaigns ADD COLUMN opening_quantity INT NOT NULL DEFAULT 0",
    'delivery_closed_at' => 'ALTER TABLE campaigns ADD COLUMN delivery_closed_at DATETIME NULL',
    'delivery_enabled' => 'ALTER TABLE campaigns ADD COLUMN delivery_enabled TINYINT NOT NULL DEFAULT 1',
    ...
    'message_extra' => "ALTER TABLE campaigns ADD COLUMN message_extra VARCHAR(500) NOT NULL DEFAULT ''",
    ...
    'beneficiaries_shelter_name' => 'ALTER TABLE beneficiaries ADD COLUMN shelter_name VARCHAR(255) NULL',
    ...
    'delivery_enabled' => 'ALTER TABLE campaigns ADD COLUMN delivery_enabled INTEGER NOT NULL DEFAULT 1',
    ...
    'message_extra' => "ALTER TABLE campaigns ADD COLUMN message_extra TEXT NOT NULL DEFAULT ''",
    ...
    'beneficiaries_shelter_name' => 'ALTER TABLE beneficiaries ADD COLUMN shelter_name TEXT',
