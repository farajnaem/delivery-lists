(function () {
    ...
    var fmt = window.RecArabicFormat || {};
    var toWesternDigits = fmt.toWesternDigits || function (s) { return String(s == null ? '' : s); };
    var formatTime12 = fmt.formatTime12 || function (t) { return String(t || ''); };
    var formatDateTimeAr = fmt.formatDateTimeAr || function (t) { return String(t || ''); };
    var localizeBeneficiary = fmt.localizeBeneficiary || function (b) { return b; };
